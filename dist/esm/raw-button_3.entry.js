...
const RawButton = class {
     ...
     */
    render() {
        return (h("button", { class: { button: true, [this.type]: true } }, h("slot", null), this.icon ? h("raw-icon", { icon: this.icon }) : null));
    }
...
const Navigation = class {
    constructor(hostRef) {
         ...
         */
        this.renderLinks = () => {
            return this.links.map(link => (h("button", { class: "link", key: link.uid }, h("span", { class: "link-text" }, h("i", { class: "link-icon", innerHTML: link.icon.src }), h("span", { class: "link-label" }, link.label)))));
        };
        /**
         * Render navigation
         */
        this.render = () => {
            return (h("div", { class: "navigation" }, h("div", { class: "brand" }, h("img", { class: "logo", src: logo }), h("div", { class: "divider" }), h("h2", { class: "title" }, "DreamBuilder")), h("div", { class: "step-list" }, this.renderSteps()), h("div", { class: "link-list" }, this.renderLinks(), h("button", { class: "save" }, h("i", { class: "link-icon", innerHTML: save.src }), h("span", { class: "save-label" }, "Save")))));
        };
